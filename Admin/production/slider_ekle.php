                  ...
                  <div class="x_content">
                    ...
                    <form action="../../connection/islem.php" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  name="slider_baslik" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12"  name="slider_sira"  required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div align="right"class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <button  name="slider_ekle" type="submit" class="btn btn-primary">Ekle</button>
                        </div>
                      </div>
                    </form>
                  </div>
